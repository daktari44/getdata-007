...
#### Processed Data
The final processed dataset consists of 180 observations of 68 variables, with each variable representing the each of the mean() and std() measurements for each activity and each subject. The variable names were edited to better reflect the meaning of the revised variables and their readability. The following is a description of the actions taken in editing the variable names:
